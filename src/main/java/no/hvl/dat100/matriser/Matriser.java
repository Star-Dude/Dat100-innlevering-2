...
public class Matriser {
	...
	// e)
	// Dette var første forsøk, og jeg kom nærme, men manglet fortsatt å bytte siste
	// element i første array med første element med siste array. Jeg implementerte
	// en 'duct tape solution' for å fikse det, men jeg visste at jeg kunne gjøre
	// bedre.
